...
<%--   </c:forEach> --%>
    ...
    <div class="bottom">
     <input type="button" onclick="slist()" value="목록">
     <input type="button" onclick="supdate('${dto.sv_num}')" value="수정">
     <input type='button' value='사진수정' onclick="updateFile('${dto.sv_num}')">
