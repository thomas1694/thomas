...
<div style="text-align: center;margin: auto;">
	<form class='content'>
		...
		<h6>전화번호</h6>
		<input type="text" id="s_Phone" value="+82"> <br>

		<h6>비지니스 카테고리를 선택하십시오</h6>
		<select>
			<option value="restaurant">레스토랑
			<option value="hospital">병원
			<option value="studycafe">스터디카페
		...
		<h6>회사위치</h6>
		<input type="text" id="s_location"> <br>

		<h6>회사명</h6>
		<input type="text" id="s_Name"> <br>

		<h6>간략한 설명을 입력하십시오.</h6>
		<textarea rows="20" cols="20"></textarea>
		<br>
