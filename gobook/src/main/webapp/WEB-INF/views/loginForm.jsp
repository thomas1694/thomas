...
var $ksy = jQuery.noConflict();   

$ksy(document).ready(function($) {
...
<div id="mw">
<!--WRAPPER-->
<div id="login_wrapper" class="content-box" style="width:310px;margin:auto;">
...
<form name="login-form" class="login-form" action="./login" method="post">
    ...
    <!--PASSWORD--><input name="passwd" type="password" class="input password" onfocus="this.value=''" /><!--END PASSWORD-->
    		...
    		<div>
    		<input type="radio" name="selectID" checked="checked" value="c_id"/>소비자
    		<input type="radio" name="selectID"  value="s_id"/>판매자
    </div></div>
    <!--END CONTENT-->
