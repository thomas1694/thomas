...
<div class="container"> 
	...
	<button class="btn btn-Default btn-md" type="button" name="" onclick="fupdate()">수정</button>
	<button class="btn btn-Default btn-md" type="button" name="" onclick="fdelete()">삭제</button>
	</div>
</body>
</html>
